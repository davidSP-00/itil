...
export class ActualizadoIncidenciasComponent implements OnInit {
  ...
  onSubmit(){
    ...
    const data={
      ...
      "fechaFin": this.actualizarForm.get('estadoIncidencia').value=="5"?moment(new Date()).format('YYYY-MM-DD hh:mm:ss A'):this.incidencia.fechaFin,
      "fechaInicio": this.actualizarForm.get('estadoIncidencia').value=="3"?moment(new Date()).format('YYYY-MM-DD hh:mm:ss A'):this.incidencia.fechaInicio,
